var CodeMirror = (function () {
  function u(aM, aJ) {
    ...
    var bX = aD.firstChild, bm = bX.firstChild, bk = aD.lastChild, bM = bk.firstChild, cg = bM.firstChild,
      aH = cg.firstChild, aY = aH.firstChild, bu = aH.nextSibling.firstChild, av = bu.firstChild, bc = av.nextSibling,
      bg = bc.nextSibling, aq = bg.nextSibling;
    cD();
    if (s) {
      bm.style.width = "0px"
    }
    ...
    function ce(c5) {
      ...
      var de = bE({line: cZ.line, ch: c0}, {line: cZ.line, ch: c0 + 1}, dg),
        c1 = c9.pos != null && bE({line: df, ch: c9.pos}, {line: df, ch: c9.pos + 1}, dg);
      var db = ar(function () {
        de.clear();
        c1 && c1.clear()
      });
...
CodeMirror.defineMode("markdown", function (B, m) {
  ...
  var y = "header", d = "comment", A = "quote", z = "string", E = "hr", s = "link", D = "string", g = "em",
    j = "strong", w = "emstrong";
  var F = /^([*\-=_])(?:\s*\1){2,}\s*$/, p = /^[*\-+]\s+/, u = /^[0-9]+\.\s+/, n = /^(?:\={3,}|-{3,})$/,
    f = /^[^\[*_\\<>`]+/;
      ...
      classtree: {
        ...
        afterrender: function (b) {
          b.el.addListener("click", function (i, k) {
            var h = Ext.get(k).up(".member"), l = h.down(".meta .defined-in"), j = l.getAttribute("rel"),
              a = h.getAttribute("id");
...
Ext.define("Docs.controller.Tabs", {
  ...
  }, {ref: "testsIndex", selector: "#testsindex"}, {ref: "commentIndex", selector: "#commentindex"}, {
    ref: "classTree",
    selector: "#classtree"
  }, {ref: "guideTree", selector: "#guidetree"}, {ref: "exampleTree", selector: "#exampletree"}, {
    ref: "videoTree",
    selector: "#videotree"
...
Ext.define("Docs.controller.Comments", {
  ...
  refs: [{ref: "viewport", selector: "#viewport"}, {ref: "index", selector: "#commentindex"}, {
...
Ext.define("Docs.view.auth.BaseForm", {
  extend: "Ext.Component", requires: ["Docs.Tip", "Docs.Auth"], createLoginFormHtml: function () {
...
Ext.define("Docs.controller.InlineExamples", {
  ...
  init: function () {
    this.control({
      classoverview: {resize: this.createResizer(".class-overview"), afterload: this.replaceExampleDivs},
...
Ext.define("Docs.view.cls.PackageLogic", {
  extend: "Docs.view.cls.Logic", requires: "Docs.ClassRegistry", create: function () {
...
Ext.define("Docs.view.comments.Template", {
  extend: "Ext.XTemplate", requires: ["Docs.Auth", "Docs.Comments"], statics: {
    create: function (d) {
...
Ext.define("Docs.view.HoverMenuButton", {
  ...
  deferShowMenu: function () {
    ...
    Docs.view.HoverMenuButton.showTimeout = Ext.Function.defer(function () {
      ...
      clearTimeout(this.hideTimeout);
      this.menu.show();
      var j = this.getEl().getXY(), n = Ext.ComponentQuery.query("classoverview toolbar")[0], k = j[0] - 10,
        l = n.getEl().getXY(), i = n.getWidth(), m = this.menu.getEl().getWidth(), h = Ext.getCmp("doctabs").getWidth();
      if (m > h) {
        k = 0
      } else {
        if ((k + m) > h) {
...
!function () {
  ...
  (function () {
    ...
    function o(ad) {
      ...
      try {
        ...
        var J = /\bMSIE\s(\d+)/.exec(navigator.userAgent), J = J && +J[1] <= 8, aa = /\n/g, C = ad.a, R = C.length,
          X = 0, U = ad.d, T = U.length, ac = 0, ab = ad.g, V = ab.length, K = 0;
        ab[V] = R;
        var Q, Z;
        for (Z = Q = 0; Z < V;) {
    ...
    var z = window, r = ["break,continue,do,else,for,if,return,while"],
    ...
    var b = z.PR = {
      ...
      prettyPrint: z.prettyPrint = function (T, Q) {
            ...
            if ((W !== M || P.test(U)) && !C.test(U)) {
              ...
              if (!p) {
                ...
                if (y.test(Y.tagName)) {
                  ...
                  var X = Y.currentStyle, V = E.defaultView,
        ...
        var L = 0, F, H = /\blang(?:uage)?-([\w.]+)(?!\S)/, P = /\bprettyprint\b/, C = /\bprettyprinted\b/,
          y = /pre|xmp/i, D = /^code$/i, O = /^(?:pre|code|xmp)$/i, M = {};
        N()
      }
    };
